...
const spinToWinUrl = "https://www.lg-theworldcomeshome.com/spin-for-your-team";
...
function footballReportTheme(html, retailer) {
  ...
  return html
    ...
    .replace(/(<div class=hero-actions>)/, `$1<a class=spin-cta href="${spinToWinUrl}" target=_blank rel=noopener>LG Spin to Win</a>`);
}

function footballChooserTheme(html) {
  return html
    .replace("</style>", `.hero{position:relative;overflow:hidden;background:radial-gradient(circle at 78% 18%,#ca0311 0,#560410 28%,#071c12 64%,#03130c 100%)!important}.hero:before{content:"";position:absolute;inset:0;background:linear-gradient(90deg,#ffffff12 1px,transparent 1px),linear-gradient(0deg,#ffffff12 1px,transparent 1px);background-size:86px 86px;opacity:.8}.hero:after{content:"";position:absolute;right:-100px;bottom:-130px;width:360px;height:360px;border:2px solid #ffffff2c;border-radius:50%;box-shadow:inset 0 0 0 70px #ffffff08}.wrap{position:relative}.campaign-crest{display:grid;gap:18px}.campaign-crest img{width:min(430px,82vw);height:auto;filter:drop-shadow(0 18px 42px #0009)}.brand .logo img{filter:brightness(0) invert(1);mix-blend-mode:normal}.brand span,.kicker{color:#ffdede!important}.copy{color:#f0ece4!important}.cards{max-width:980px}.card,.campaign-panel{position:relative;overflow:hidden;border-color:#ffffff38!important;box-shadow:0 24px 70px #0009!important}.card:before,.campaign-panel:before{content:"";position:absolute;inset:0;background:linear-gradient(135deg,#ffffff16,transparent 45%);pointer-events:none}.john{background:linear-gradient(135deg,#f4f1ea 0,#fff 62%,#e8e0d4 100%)!important;color:#111!important;border-color:#111!important}.john:after{content:"";position:absolute;left:0;right:0;bottom:0;height:7px;background:#111}.john b{background:#111!important;color:white!important;border-color:#111!important}.john p{color:#2f3834!important}.currys{background:linear-gradient(135deg,#4c12a1 0,#2b106b 55%,#ca0311 100%)!important;border-color:#fff8!important;color:#fff!important}.currys:after{content:"";position:absolute;left:0;right:0;bottom:0;height:7px;background:#ffdd00}.currys b{background:#fff!important;color:#4c12a1!important;border-color:#fff!important}.currys p{color:#f0ece4!important}.campaign-panel{display:grid;grid-template-columns:minmax(0,1fr) auto;gap:16px;align-items:center;max-width:980px;margin-top:-34px;border:1px solid #fff8;border-radius:8px;padding:20px 22px;background:linear-gradient(135deg,#f0ece4 0,#ffd76b 34%,#ca0311 68%,#4c12a1 100%);color:#111;text-decoration:none}.campaign-panel strong{display:block;font-size:24px;line-height:1}.campaign-panel span{display:block;margin-top:8px;font-size:14px;font-weight:800;line-height:1.4}.campaign-panel b{display:inline-flex;align-items:center;justify-content:center;min-height:40px;border-radius:8px;background:#111;color:#fff;padding:9px 12px;font-size:13px}.home{color:#f0ece4!important}@media(max-width:740px){.campaign-panel{grid-template-columns:1fr;margin-top:-28px}.campaign-panel b{width:max-content}}</style>`)
    ...
    .replace('</div><a class=home href=../>Back to portfolio</a>', `</div><a class=campaign-panel href="${spinToWinUrl}" target=_blank rel=noopener><div><strong>LG Spin to Win</strong><span>Open LG's World Cup campaign experience.</span></div><b>Open campaign</b></a><a class=home href=../>Back to portfolio</a>`);
}
...
const johnLewisReport = fs.existsSync("upload-index.html")
  ? footballReportTheme(normalizeReportHtml(read("upload-index.html"), "John Lewis"), "John Lewis")
  : normalizeReportHtml(read("john-lewis/index.html"), "John Lewis");
